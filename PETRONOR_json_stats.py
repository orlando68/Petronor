...
def find_closest(date):
    ...
    indexes_b = [
                 int(harm.iloc[indice]['i Oil Whirl']),
                 int(harm.iloc[indice]['i Flow T.']),
                 int(harm.iloc[indice]['i 1/4' ]),
                 int(harm.iloc[indice]['i 1/3' ]),
                 int(harm.iloc[indice]['i 0.5' ]),
                 int(harm.iloc[indice]['i 2nd Highest']), 
                 int(harm.iloc[indice]['i 1.0']),
                 int(harm.iloc[indice]['i 1.5']),
                 int(harm.iloc[indice]['i 2.0']),
                 int(harm.iloc[indice]['i 2.5']), 
                 int(harm.iloc[indice]['i 3.0']),
                 int(harm.iloc[indice]['i 3.5']),
                 int(harm.iloc[indice]['i 4.0']),
                 int(harm.iloc[indice]['i 5.0']),
                 int(harm.iloc[indice]['i 1BPF']), 
                 int(harm.iloc[indice]['i 1BPF-1.0']),
                 int(harm.iloc[indice]['i 1BPF+1.0']),
                 int(harm.iloc[indice]['i 2BPF']),
                 int(harm.iloc[indice]['i 2BPF-1.0']),
                 int(harm.iloc[indice]['i 2BPF+1.0'])
                 ]#, df_speed.iloc[indice]['i 0.83 33.33'] ]
    #indexes_b = indexes_b.astype(int)
    ...
    print(f[indexes_b])
    print(f[indexes_c])
    plt.plot(f[indexes_c]   , cte_p*2*sptrm_P[indexes_c]  ,'o')
