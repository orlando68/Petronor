...
def velocity(df_in):
    ...
    df_cmplx  = pd.DataFrame(np.nan,index = df_in.index,columns = df_in.columns.values)
    ...
    return df_speed,df_cmplx#,df_angle
#------------------------------------------------------------------------------
...
def Cavitation_Noise(df_in):
    ...
    for i in range (n_traces):
        if df_in.iloc[i]['RMS (mm/s) f'] < 0.3:
            ...
            if df_in.loc[df_in.index[i],'$Cavitation_Noise'] == 'None':
                print ('Fallo en:', i)
...
def Rotating_Cavitation(df_in):
    ...
    for i in range (n_traces):
        if df_in.iloc[i]['RMS (mm/s) f'] < 0.3:
            ...
            if df_in.loc[df_in.index[i],'$Rotating_Cavitation'] == 'None':
                print ('Fallo en:', i)
...
def R_Rotating_Stall(df_in):
    ...
    for i in range (n_traces):
        if df_in.iloc[i]['RMS (mm/s) f'] < 0.3:
            ...
            if df_in.loc[df_in.index[i],'$R_Rotating_Stall'] == 'None':
                print ('Fallo en:', i)
