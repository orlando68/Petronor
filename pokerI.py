...
def Seconds_JsonTime(seconds):
    ...
    return JsonTime
#@jit
def Read_server(parameters,df_SH3,df_SH4):
    ...
    for lecture in response_json[0]['waveform'][0]['ValoresTrama']:
        if lecture != None:
            ...
            if  std_SH3 > 0.001:
                ...
                SPEED_SH3.append(array_SH3)
                FECHA_SH3.append(seg_SH3)
            else:
    ...
    for lecture in response_json[0]['waveform'][1]['ValoresTrama']:
        if lecture != None:
            ...
            if std_SH4 > 0.001:
                ...
                SPEED_SH4.append(array_SH4)
                FECHA_SH4.append(seg_SH4)
            else:
                print('maquina parada')
        else:
            print('lectura corrupta')
    ...
    return SPEED_SH3,FECHA_SH3,SPEED_SH4,FECHA_SH4,ulti_fecha
...
if __name__ == '__main__':
    ...
    while JsonTime_Seconds(fecha_stop) < JsonTime_Seconds(parameters['Fecha']) :
        ...
        data_SH3,date_SH3,data_SH4,date_SH4,last_data = Read_server(parameters)    
        ...
        SP_SH3 = SP_SH3 + data_SH3
        SC_SH3 = SP_SH3 + date_SH3
        SP_SH4 = SP_SH4 + data_SH4
        SC_SH4 = SP_SH4 + date_SH4
#    df_SH3     = pd.DataFrame(data=SP_SH3, index=SC_SH3)
#    df_SH3.sort_index(inplace=True)
#        
#    df_SH4     = pd.DataFrame(data=SP_SH4, index=SC_SH4)
